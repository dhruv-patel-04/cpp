...
public :
    friend class student;   //here whole class is made friend
}r;


void student :: getdata_result(result &r)       //accessed through friend class
{
...
void student :: putdata_result(result &r)   //accessed through friend class
{
